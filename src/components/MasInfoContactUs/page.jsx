...
export default function MasInfoContactUs() {
  return (
    <>
      ...
      <div className="w-11/12 flex flex-wrap gap-10 justify-center">
        <div className="w-[400px] rounded-2xl shadow-xl p-10">
        ...
        <div className="w-[400px] rounded-2xl shadow-xl p-10">
          ...
          <a
            target="_blank"
            href="https://m.facebook.com/CursosdeInglesUsa"
            className="text-[#000b7a] text-xl py-1 flex gap-2 items-center cursor-pointer hover:text-[#90d400]"
          >
          ...
          <a
            target="_blank"
            href="https://x.com/fyrloisoficial?s=11"
            className="text-[#000b7a] text-xl py-1 flex gap-2 items-center cursor-pointer hover:text-[#90d400]"
          >
            <span className="p-2 rounded-full bg-[#90d400] text-white ">
              {" "}
          ...
          <a
            target="_blank"
            href="https://www.instagram.com/fyrloisusa?igsh=ZWtjcjBhcTN2cmtw"
            className="text-[#000b7a] text-xl py-1 flex gap-2 items-center cursor-pointer hover:text-[#90d400]"
          >
            <span className="p-2 rounded-full bg-[#90d400] text-white ">
              <FaInstagram />
